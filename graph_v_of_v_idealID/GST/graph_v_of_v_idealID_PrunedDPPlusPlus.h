...
#include <graph_hash_of_mixed_weighted/graph_hash_of_mixed_weighted_PrunedDPPlusPlus_edge_weighted.h>
...
#pragma region
void test_graph_v_of_v_idealID_PrunedDPPlusPlus() {

	/*parameters*/
	int iteration_times = 100;
	int V = 1000, E = 10000, G = 6, g_size_min = 10, g_size_max = 50, precision = 3;
...
#pragma endregion test_graph_v_of_v_idealID_PrunedDPPlusPlus
