...
void example_list_all_files_in_a_directory() {
    ...
    std::string path = "C:/Users/Yahui/Google Drive/ysgraph";
    vector<pair<string, bool>> files = list_all_files_in_a_directory(path);
