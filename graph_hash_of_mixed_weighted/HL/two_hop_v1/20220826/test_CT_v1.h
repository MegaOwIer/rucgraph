...
#include <graph_hash_of_mixed_weighted/HL/two_hop_v1/test_CT_v1.h>
...
void test_CT() {
	...
	/*parameters*/
	int iteration_graph_times = 2e2, iteration_source_times = 100, iteration_terminal_times = 100;
	int V = 10, E = 12, precision = 1;
