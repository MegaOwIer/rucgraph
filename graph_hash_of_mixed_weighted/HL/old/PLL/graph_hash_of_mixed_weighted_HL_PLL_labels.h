...
class graph_hash_of_mixed_weighted_HL_PLL_label {
public:
	int vertex, parent_vertex; // std::vector<PLL_sorted_label> should be sorted by vertex
	float distance;
};

void graph_hash_of_mixed_weighted_HL_PLL_label_binary_insert(std::vector<graph_hash_of_mixed_weighted_HL_PLL_label>& input_vector, int vertex, int parent_vertex, float distance) {
	...
	graph_hash_of_mixed_weighted_HL_PLL_label x;
	x.vertex = vertex;
...
vector<vector<graph_hash_of_mixed_weighted_HL_PLL_label>> graph_hash_of_mixed_weighted_HL_PLL_read_indexes_binary(string index_file_name) {

	vector<vector<graph_hash_of_mixed_weighted_HL_PLL_label>> L;
...
float graph_hash_of_mixed_weighted_HL_PLL_extract_distance(vector<vector<graph_hash_of_mixed_weighted_HL_PLL_label>>& L, int source, int terminal) {
...
vector<pair<int, int>> graph_hash_of_mixed_weighted_HL_PLL_extract_shortest_path(vector<vector<graph_hash_of_mixed_weighted_HL_PLL_label>>& L, int source, int terminal) {
